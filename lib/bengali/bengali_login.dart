...
import 'package:firebase_auth101/bengali/bengali_forgot.dart';
...
class bengaliLogin extends StatefulWidget {
  bengaliLogin() : super();
...
class _SearchScreenState extends State<bengaliLogin> {
                ...
                child: Align(
                    ...
                    child: Material(
                      ...
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                              builder: (context) => const bengaliForgotPassword()));},
                        child: Text(
       ...
       Padding(
                ...
                child: Row(
                  children: [
                    ...
                    const Text("অথবা লগইন করুন",style: TextStyle(
