...
import 'package:firebase_auth101/payment/payment3.dart';
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: [
                              ...
                              TextSpan(
                                                                text: 'Discussions with our members is something we enjoy doing, on demand.\n\n\nSTARTING PRICE                             @ RS 200/hr\n\n OTHERS                                          @(ACCORDINGLY)',
            ...
            TextButton(
              ...
              onPressed: () {
                        ...
                        Navigator.of(context).pushReplacement(MaterialPageRoute(
                          builder: (context) =>const PaymentPage3()));
