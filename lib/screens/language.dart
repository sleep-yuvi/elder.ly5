            ...
            child: Padding(
              ...
              child: Column(
                ...
                child: Container(
                  ...
                  child:  Center(child: Text("English" ,style: TextStyle(color: Colors.white,fontSize: 20, fontFamily: 'Comfortaa',)))
                ),
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap:  () { 
                Navigator.push(context, MaterialPageRoute(builder: (_)=> Hindi_Login()));
                },
                child: Container(
                  height: 50,
                  width: double.infinity,
                  ...
                  child:  Center(child: Text("हिंदी" ,style: TextStyle(color: Colors.white,fontSize: 20, fontFamily: 'Comfortaa',)))
                ),
                  ...
                  Padding(
                    ...
                    child: InkWell(
                      onTap:  () { 
                Navigator.push(context, MaterialPageRoute(builder: (_)=> bengaliLogin()));
                },
                child: Container(
                  height: 50,
                  width: double.infinity,
                  ...
                  child:  Center(child: Text("বাংলা" ,style: TextStyle(color: Colors.white,fontSize: 20, fontFamily: 'Comfortaa',)))
                ),
